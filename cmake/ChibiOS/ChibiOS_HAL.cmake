...
SET (CHIBIOS_SOURCES_hal_WSPI        os/hal/src/hal_wspi.c)
...
SET (CHIBIOS_SOURCES_hal_WSPI_F2    os/hal/ports/STM32/LLD/QUADSPIv1/hal_wspi_lld.c)
...
SET (CHIBIOS_INCLUDES_hal_WSPI_F2   os/hal/ports/STM32/LLD/QUADSPIv1)
...
SET (CHIBIOS_SOURCES_hal_WSPI_F4    os/hal/ports/STM32/LLD/QUADSPIv1/hal_wspi_lld.c)
...
SET (CHIBIOS_INCLUDES_hal_WSPI_F4   os/hal/ports/STM32/LLD/QUADSPIv1)
...
SET (CHIBIOS_SOURCES_hal_WSPI_F7    os/hal/ports/STM32/LLD/QUADSPIv1/hal_wspi_lld.c)
...
SET (CHIBIOS_INCLUDES_hal_WSPI_F7   os/hal/ports/STM32/LLD/QUADSPIv1)
...
SET (CHIBIOS_SOURCES_hal_WSPI_L4    os/hal/ports/STM32/LLD/QUADSPIv1/hal_wspi_lld.c)
...
SET (CHIBIOS_INCLUDES_hal_WSPI_L4   os/hal/ports/STM32/LLD/QUADSPIv1)
...
SET (CHIBIOS_INCLUDES_hal_H7
        ...
        os/hal/ports/STM32/LLD/QUADSPIv2
        os/hal/ports/STM32/LLD/SDMMCv2
        os/hal/ports/STM32/LLD/USART
        )

SET (CHIBIOS_SOURCES_hal_H7
        ...
        os/hal/ports/STM32/LLD/QUADSPIv2/hal_wspi_lld.c
        os/hal/ports/STM32/LLD/SDMMCv2/hal_sdc_lld.c
        )

SET (CHIBIOS_SOURCES_hal_ADC_H7     os/hal/ports/STM32/LLD/ADCv2/hal_adc_lld.c)
SET (CHIBIOS_SOURCES_hal_CAN_H7     os/hal/ports/STM32/LLD/CANv1/hal_can_lld.c)
SET (CHIBIOS_SOURCES_hal_CRY_H7     os/hal/ports/STM32/LLD/CRYPv1/hal_crypto_lld.c)
SET (CHIBIOS_SOURCES_hal_DAC_H7     os/hal/ports/STM32/LLD/DACv1/hal_dac_lld.c)
SET (CHIBIOS_SOURCES_hal_EXT_H7     os/hal/ports/STM32/LLD/EXTIv1/hal_ext_lld.c)
SET (CHIBIOS_SOURCES_hal_PAL_H7     os/hal/ports/STM32/LLD/GPIOv2/hal_pal_lld.c)
SET (CHIBIOS_SOURCES_hal_I2C_H7     os/hal/ports/STM32/LLD/I2Cv3/hal_i2c_lld.c)
SET (CHIBIOS_SOURCES_hal_MAC_H7     os/hal/ports/STM32/LLD/MACv1/hal_mac_lld.c)
SET (CHIBIOS_SOURCES_hal_USB_H7     os/hal/ports/STM32/LLD/OTGv1/hal_usb_lld.c)
SET (CHIBIOS_SOURCES_hal_WSPI_H7    os/hal/ports/STM32/LLD/QUADSPIv1/hal_wspi_lld.c)
SET (CHIBIOS_SOURCES_hal_RTC_H7     os/hal/ports/STM32/LLD/RTCv2/hal_rtc_lld.c)
SET (CHIBIOS_SOURCES_hal_I2S_H7     os/hal/ports/STM32/LLD/SPIv2/hal_i2s_lld.c)
SET (CHIBIOS_SOURCES_hal_SPI_H7     os/hal/ports/STM32/LLD/SPIv3/hal_spi_lld.c)
SET (CHIBIOS_SOURCES_hal_SDC_H7     os/hal/ports/STM32/LLD/SDMMCv1/hal_sdc_lld.c)
SET (CHIBIOS_SOURCES_hal_GPT_H7     os/hal/ports/STM32/LLD/TIMv1/hal_gpt_lld.c)
SET (CHIBIOS_SOURCES_hal_ICU_H7     os/hal/ports/STM32/LLD/TIMv1/hal_icu_lld.c)
SET (CHIBIOS_SOURCES_hal_PWM_H7     os/hal/ports/STM32/LLD/TIMv1/hal_pwm_lld.c)
SET (CHIBIOS_SOURCES_hal_SERIAL_H7  os/hal/ports/STM32/LLD/USARTv2/hal_serial_lld.c)
SET (CHIBIOS_SOURCES_hal_UART_H7    os/hal/ports/STM32/LLD/USARTv2/hal_uart_lld.c)
SET (CHIBIOS_SOURCES_hal_WDG_H7     os/hal/ports/STM32/LLD/xWDGv1/hal_wdg_lld.c)

SET (CHIBIOS_INCLUDES_hal_ADC_H7    os/hal/ports/STM32/LLD/ADCv2)
SET (CHIBIOS_INCLUDES_hal_CAN_H7    os/hal/ports/STM32/LLD/CANv1)
SET (CHIBIOS_INCLUDES_hal_CRY_H7    os/hal/ports/STM32/LLD/CRYPv1)
SET (CHIBIOS_INCLUDES_hal_DAC_H7    os/hal/ports/STM32/LLD/DACv1)
SET (CHIBIOS_INCLUDES_hal_EXT_H7    os/hal/ports/STM32/LLD/EXTIv1)
SET (CHIBIOS_INCLUDES_hal_PAL_H7    os/hal/ports/STM32/LLD/GPIOv2)
SET (CHIBIOS_INCLUDES_hal_I2C_H7    os/hal/ports/STM32/LLD/I2Cv3)
SET (CHIBIOS_INCLUDES_hal_MAC_H7    os/hal/ports/STM32/LLD/MACv1)
SET (CHIBIOS_INCLUDES_hal_USB_H7    os/hal/ports/STM32/LLD/OTGv1)
SET (CHIBIOS_INCLUDES_hal_WSPI_H7   os/hal/ports/STM32/LLD/QUADSPIv1)
SET (CHIBIOS_INCLUDES_hal_RTC_H7    os/hal/ports/STM32/LLD/RTCv2)
SET (CHIBIOS_INCLUDES_hal_I2S_H7    os/hal/ports/STM32/LLD/SPIv2)
SET (CHIBIOS_INCLUDES_hal_SPI_H7    os/hal/ports/STM32/LLD/SPIv3)
SET (CHIBIOS_INCLUDES_hal_SDC_H7    os/hal/ports/STM32/LLD/SDMMCv1)
SET (CHIBIOS_INCLUDES_hal_GPT_H7    os/hal/ports/STM32/LLD/TIMv1)
SET (CHIBIOS_INCLUDES_hal_ICU_H7    os/hal/ports/STM32/LLD/TIMv1)
SET (CHIBIOS_INCLUDES_hal_PWM_H7    os/hal/ports/STM32/LLD/TIMv1)
SET (CHIBIOS_INCLUDES_hal_SERIAL_H7 os/hal/ports/STM32/LLD/USARTv2)
SET (CHIBIOS_INCLUDES_hal_UART_H7   os/hal/ports/STM32/LLD/USARTv2)
SET (CHIBIOS_INCLUDES_hal_WDG_H7    os/hal/ports/STM32/LLD/xWDGv1)
