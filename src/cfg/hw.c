...
void uart1_init(void){
	...
	palSetLineMode(LINE_GPIOA_9, PAL_MODE_ALTERNATE(4)); //TX
	palSetLineMode(LINE_GPIOA_10, PAL_MODE_ALTERNATE(4)); //RX
}
////////////////////////////////////////////////////////////////////////////////////////////
#endif
...
////////////////////////////////////////////////////////////////////////////////////////////
// UART 2 / USB / NUCLEO BOARD DEBUG
////////////////////////////////////////////////////////////////////////////////////////////
static const SerialConfig uart2cfg = {
		9600,
		0,
		USART_CR2_STOP1_BITS | USART_CR2_LINEN,
		0
...
void uart2_init(void){
	...
	palSetLineMode(LINE_GPIOA_2, PAL_MODE_ALTERNATE(4));
	palSetLineMode(LINE_GPIOA_3, PAL_MODE_ALTERNATE(4));
}
////////////////////////////////////////////////////////////////////////////////////////////
#endif
...
void device_wind_init(void){
	palSetLineMode(WIND_SPEED_INPUT_PIN, PAL_MODE_INPUT_PULLUP);
}
#endif
////////////////////////////////////////////////////////////////////////////////////////////
